    ...
    while not stopping_condition:
        ...
        for minibatch_index in tqdm(range(N // minibatch_size)):
            ...
            for example_index in range(minibatch_size):
                ...
                # custom_print(predicted_label, gold_label)
                total += 1
                if loss is None:
                    loss = example_loss
                else:
            ...
            loss.backward()
            optimizer.step()
        custom_print(loss_total/loss_count)
        custom_print("Training completed for epoch {}".format(epoch + 1))
        custom_print("Training accuracy for epoch {}: {}".format(epoch + 1, correct / total))
        ...
        custom_print("Validation accuracy for epoch {}: {}".format(epoch + 1, correct / total))
        validation_accuracy = correct/total

        if validation_accuracy < last_validation_accuracy and trainning_accuracy > last_train_accuracy:
            stopping_condition=True
            custom_print("Training done to avoid overfitting!")
            custom_print(f"Best validation accuracy is: {last_validation_accuracy}")
        else:
